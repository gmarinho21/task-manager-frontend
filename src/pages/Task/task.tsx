...
function TaskLayout() {
  ...
  const getTasks = async () => {
    ...
    const response = await fetch("http://https://tasg-backend-production.up.railway.app:3000/tasks", {
      method: "GET",
      mode: "cors",
      headers: {
  ...
  const updateTask = useMutation(async ({taskID, conditionToSet}: TasksEntryVariables) => {
    const token = localStorage.getItem("token")
    await fetch("http://https://tasg-backend-production.up.railway.app:3000/tasks/" + taskID, {
    method: "PATCH",
    mode: "cors",
    headers: {
  ...
  const addTask = useMutation(async () => {
    ...
    await fetch("http://https://tasg-backend-production.up.railway.app:3000/tasks/", {
      method: "POST",
      mode: "cors",
      headers: {
        "Content-Type": "application/json",
